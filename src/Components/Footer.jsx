...
<footer class=" dark:bg-orange-400">
    <div class="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
        <div>
            <h2 class="mb-6 text-sm font-semibold text-white uppercasse">Company</h2>
            <ul class="text-white">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-sm font-semibold text-white">Help center</h2>
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400">
                ...
                <li class="mb-4">
                    <a href="/" class="hover:underline text-white">Licensing</a>
                </li>
                <li class="mb-4">
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400">
                <li class="mb-4">
                    <a href="/" class="hover:underline text-white">iOS</a>
                </li>
                <li class="mb-4">
                    <a href="/" class="hover:underline text-white">Android</a>
                </li>
                <li class="mb-4">
                    <a href="/" class="hover:underline text-white">Windows</a>
                </li>
                <li class="mb-4">
                    <a href="/" class="hover:underline text-white">MacOS</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="px-4 py-6 bg-orange-400 md:flex md:items-center md:justify-between">
